...
class App extends Component {
  ...
  initGameState() {
    return {
      ...
      cards: [
        {id: 1, flipped: false, inPlay: true, canClick: true},
        {id: 2, flipped: false, inPlay: true, canClick: true},
        {id: 3, flipped: false, inPlay: true, canClick: true},
        {id: 4, flipped: false, inPlay: true, canClick: true},
        {id: 5, flipped: false, inPlay: true, canClick: true},
        {id: 6, flipped: false, inPlay: true, canClick: true},
        {id: 7, flipped: false, inPlay: true, canClick: true},
        {id: 8, flipped: false, inPlay: true, canClick: true},
        {id: 9, flipped: false, inPlay: true, canClick: true},
        {id: 10, flipped: false, inPlay: true, canClick: true},
        {id: 11, flipped: false, inPlay: true, canClick: true},
        {id: 12, flipped: false, inPlay: true, canClick: true},
        {id: 13, flipped: false, inPlay: true, canClick: true},
        {id: 14, flipped: false, inPlay: true, canClick: true},
        {id: 15, flipped: false, inPlay: true, canClick: true},
        {id: 16, flipped: false, inPlay: true, canClick: true},
        {id: 17, flipped: false, inPlay: true, canClick: true},
        {id: 18, flipped: false, inPlay: true, canClick: true},
        {id: 19, flipped: false, inPlay: true, canClick: true},
        {id: 20, flipped: false, inPlay: true, canClick: true}
      ]
    };
  }
	     ...
	     //there is already a card selected
	    	...
	    	setTimeout(function() {
	        	...
	        	context.setState((prevState, props) => ({
	        		gameRunning: matchesLeft() ? true : false,
